...
#+END_NOTES
* how to plan an internationalization launch 
...
*** Hebrew (RtL) 
:PROPERTIES:
:reveal_background: https://ews.github.io/wikipedia_hebrew.png
:reveal_background_trans: slide
:END:
*** Italian
:PROPERTIES:
:reveal_background: https://ews.github.io/wikipedia_italian.png
:reveal_background_trans: slide
:END:
*** changing language 
 #+BEGIN_NOTES
...
:PROPERTIES:
:reveal_background: https://upload.wikimedia.org/wikipedia/commons/8/8c/EF_EPI_2016_World_map.jpg
:reveal_background_trans: slide
:END:
#+BEGIN_NOTES
...
mejorar comunicacion: hablar de mad libs Etsy Japan
#+END_NOTES
...
wahtsapp 
#+END_NOTES
** when you need international to growth  
...
** Japan 
*** Case: Etsy Japan 
    :PROPERTIES: https://cdn.techinasia.com/wp-content/uploads/2014/04/EtsyTIAJPG-720x503.jpg
    :reveal_background: #123456
    :END:
  #+BEGIN_NOTES
  Pictures: 
...
*  
   ...
   :PROPERTIES:
   :reveal_background: https://ews.github.io/thank_you.png
   :reveal_background_trans: slide
   :END:
